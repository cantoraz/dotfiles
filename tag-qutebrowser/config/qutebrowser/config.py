...
## Load color theme
config.source("colors/tomorrow-hybrid.config.py")
...
for p in ["dict.cn", "elpa.gnu.org", "proxy.golang.org", "qute://*"]:
...
c.editor.command = ["emacs", "{file}", "+{line}:{column0}"]
...
c.tabs.title.format_pinned = "{audio}{index} 󰐃"
...
c.url.searchengines = {
    ...
    "d": "https://dict.cn/search?q={}",
    "ddg": "https://duckduckgo.com/?q={}",
    "g": "https://www.google.com/search?q={}",
    "gt": "https://translate.google.com/?op=translate&sl=auto&tl=zh-CN&text={}",
    "w": "https://www.wikipedia.org/search-redirect.php?language=en&search={}",
    "wz": "https://www.wikipedia.org/search-redirect.php?language=zh&search={}",
...
config.bind(",,", "jseval -q document.activeElement.blur()")

config.bind(";v", "hint links spawn --detach smplayer {hint-url}")
config.bind("Cs", "config-source")
config.bind("ch", "history-clear")
config.bind("tdh", "config-cycle -p -t -u *://{url:host}/* colors.webpage.darkmode.enabled ;; reload")  # fmt: skip
config.bind("tt", "config-cycle -t tabs.show never always")
config.bind("xd", "yank -skq selection ;; spawn --detach goldendict {primary}")
config.bind("xf", "spawn --detach firefox {url}")
config.bind("xv", "spawn --detach smplayer {url}")
...
config.bind("d", "yank -skq selection ;; cmd-later 0 spawn --detach goldendict {primary}", mode="caret")  # fmt: skip
